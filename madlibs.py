...
def show_madlib_form():
    ...
    player = request.args.get("person")
    response = request.args.get("yes/no")
...
@app.route('/madlib')
def show_madlib():
    color = request.args.get("ml_color")
    noun = request.args.get("ml_noun")
    person = request.args.get("ml_person")
    adjective = request.args.get("ml_adjective")
